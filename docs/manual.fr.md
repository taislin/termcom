# termcom — Manuel du Démake Roguelike ASCII de X-COM (v0.50.5)
...
16. [Tables de Référence](#tables-de-référence)
...
| Type | Car. | Couverture | Notes |
|------|------|------------|-------|
| Sol | `.` | 0 % | Sol par défaut |
| Mur | `#` | 80 % | Bloque mouvement et ligne de vue |
| Porte | `+` | 0 % | S'ouvre au contact |
| Fenêtre | `¤` | 0 % | Bloque ligne de vue, franchissable |
| Herbe | `·` | 0 % | Inflammable |
| Arbre | `♣` | 60 % | Bloque ligne de vue, inflammable |
| Roche | `∩` | 70 % | Bloque ligne de vue |
| Eau | `≈` | 0 % | Infranchissable |
| Sol d'OVNI | `≡` | 0 % | Revêtement intérieur |
| Mur d'OVNI | `█` | 80 % | Bloque mouvement et ligne de vue |
| Escalier | `▓` / `▒` | 0 % | Transition de niveau |
| Trottoir | `░` | 0 % | Route / aire d'atterrissage |
| Sable | `·` | 0 % | Terrain désertique |
| Neige | `∗` | 0 % | Terrain polaire |
| Marécage | `≋` | 0 % | Terrain marécageux |
| Buisson | `†` | 40 % | Couverture légère, inflammable |
| Clôture | `║` | 30 % | Couverture minimale, inflammable |
| Décombres | `▒` | 20 % | Terrain détruit |
| Mobilier | `■` `⚙` `◈` `⌁` `▤` `⊕` `⎔` `⊟` `⌨` `□` `◫` `⊞` | 50 % | Objets OVNI/bâtiment |

### Types de Dégâts

| Type | Source |
|------|--------|
| Cinétique | Pistolet, Fusil, Canon Lourd, Canon Automatique |
| Laser | Pistolet Laser, Fusil Laser |
| Plasma | Pistolet à Plasma, Fusil à Plasma, Plasma Lourd, Grenade Alien |
| Explosif | Lance-Roquettes, Grenades, Mines |
| Mêlée | Bâton Électrique, Griffe de Chryssalide, Griffe Faucheuse |
| Psionique | Attaques psi Éthéréennes |

### Terrain Destructible

| Case | Devient | Changement couverture |
|------|---------|-----------------------|
| Mur / Mur d'OVNI | Décombres | 80 % → 20 % |
| Arbre | Décombres | 60 % → 20 % |
| Roche | Décombres | 70 % → 20 % |
| Clôture | Décombres | 30 % → 20 % |

### Gaz (des grenades)

| Densité | Visuel | Bloque ligne de vue ? | Pénalité couverture |
|---------|--------|-----------------------|---------------------|
| Épais (3) | ▓ | Oui | 40 % |
| Moyen (2) | ▒ | Non | 20 % |
| Fin (1) | ░ | Non | 0 % |

Le gaz se propage aux cases adjacentes et s'amincit chaque tour jusqu'à se dissiper.
...
| Propagation | Chance par tour vers une case inflammable adjacente |
| Inflammable | Herbe, Arbre, Buisson, Clôture, Porte |
| Durée | ~3 tours, puis la case devient Sol |

### Fabrication

| Objet | Temps | Matériaux |
|-------|-------|-----------|
| Pistolet | 3 jours | 1 alliage |
| Fusil | 5 jours | 2 alliages |
| Canon Lourd | 7 jours | 3 alliages |
| Canon Automatique | 6 jours | 3 alliages |
| Lance-Roquettes | 8 jours | 4 alliages, 1 élérium |
| Bâton Électrique | 2 jours | 1 alliage |
| Armure Personnelle | 6 jours | 2 alliages |
| Tenue Légère | 10 jours | 4 alliages, 1 élérium |
| Tenue Intermédiaire | 14 jours | 6 alliages, 2 élérium |
| Tenue Lourde | 18 jours | 8 alliages, 3 élérium |
| Trousse Médicale | 3 jours | 1 alliage |
