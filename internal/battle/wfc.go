...
func loadWFCLibrary(stem string) []WFCTile {
	...
	log.Printf("wfc: required library %q not found in any search path, using empty tileset", stem)
	return nil
}
