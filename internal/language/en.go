...
func init() {
	register("en", map[string]string{
		...
		"GEO_HEADER_REGION":             "REGION",
		"GEO_HEADER_THREAT":             "THREAT",
		"GEO_HEADER_RADAR":              "RADAR",
		"GEO_HEADER_SQD":                "SQD",
		"GEO_HEADER_STATUS":             "STATUS",
		"GEO_RADAR_ON":                  " R ",
		"GEO_RADAR_OFF":                 " - ",
		...
		"MSG_CANNOT_SELL":           "No facility of that type to sell!",
		...
		"WEAPON_STAT_COST":              "Cost",
		"WEAPON_PARAM_COUNT":            "Build Qty: %d",
		"WEAPON_MSG_BUILT":              "Weapon built: %s",
		"WEAPON_MSG_BUILT_MULTI":        "Built %d x %s",
		"WEAPON_MSG_INSUFFICIENT_FUNDS": "Insufficient funds!",
		"WEAPON_LABEL_BASE":             "Base:",
		"WEAPON_LABEL_COST":             "Cost: $%dk",
		"WEAPON_DESIGNER_HELP":          "[\u2191\u2193] Nav  [\u2190\u2192] Adjust  [Tab] Next  [+]/[-]=Qty  [Enter] Build  [Esc] Cancel",
		...
		"MSG_BACKPACK_MAX":   "Max %d %s per soldier",
		"MSG_BACKPACK_ADD":   "+1 %s",
		"MSG_BACKPACK_NONE":  "No %s to remove",
		"MSG_BACKPACK_REMOVE": "-1 %s",
		"MSG_NO_SOLDIERS_SELECTED": "No soldiers selected!",
		"LOADOUT_TITLE":      "DEPLOY: %s at %s",
		"LOADOUT_SUMMARY":    "Selected: %d / %d deployable",
		"LOADOUT_LAUNCH_HELP": "Press [Enter] or [L] to launch mission",
		"HELP_LOADOUT":       "[\u2191]/[\u2193]=Select  [Space]=Toggle  [1]=Wpn  [2]=Arm  [3]=Back  [+]/[-]=Qty  [Enter]/[L]=Launch  [Esc]=Back",
